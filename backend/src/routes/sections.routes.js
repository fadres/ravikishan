...
//
// ROUTE ORDER MATTERS: when the cross-section fan-out endpoint
// (GET /api/sections/search, single segment) lands in Task 5, it MUST be
// registered BEFORE the /:sectionId handlers — a single segment matches any
// id, including "search". The /:sectionId/search and /:sectionId/ai/ask
// two-segment paths below cannot be swallowed by /:sectionId.
...
import { searchWithinSection } from '../services/search.js';
